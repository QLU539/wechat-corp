...
public class MessageSend {
	...
	public static void main(String[] args) {
		try {
			...
			String img0 = URLDecoder.decode(MediaMaterial.class.getResource("/com/wechat/corp/test/1.jpg")
					.getPath(), "UTF-8");
			File f0 = new File(img0);
			...
			String video2 = URLDecoder.decode(MediaMaterial.class.getResource("/com/wechat/corp/test/demo.mp4")
					.getPath(), "UTF-8");
			...
			String file3 = URLDecoder.decode(
					MediaMaterial.class.getResource("/com/wechat/corp/test/基于BS架构的服务器主动推送技术.doc").getPath(),
					"UTF-8");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////			
			...
			JSONObject json0 = CgiUtils.getMessageText("llh", null, null,
					Constants.TEST_AGENTID, "text消息，这是一条测试消息！", 0);
			System.out.println("text消息：" + Message.send(json0, wc, wc.getAccessToken()));

////////////////////////////////////////////////////////////////////////////////////////////////////////////
			
			wc.setCorpSecret(Constants.ASSISTANT_SECRET);
			
			System.out.println("发送image消息。");
			JSONObject json1 = CgiUtils.getMessageImage("llh", null, null,
					Constants.ASSISTANT_AGENTID, mediaId0, 0);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			JSONObject json3 = CgiUtils.getMessageVideo("llh", null, null,
					Constants.TEST_AGENTID, mediaId2, "video消息", "这是一条测试视频消息！", 0);
			System.out.println("video消息：" + Message.send(json3, wc, wc.getAccessToken()));

////////////////////////////////////////////////////////////////////////////////////////////////////////////
			
			System.out.println("发送file消息。");
			JSONObject json4 = CgiUtils.getMessageFile("llh", null, null,
					Constants.TEST_AGENTID, mediaId3, 0);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			JSONObject json5 = CgiUtils.getMessageNews("llh", null, null,
					Constants.ASSISTANT_AGENTID, newsItems);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			JSONObject json6 = CgiUtils.getMessageMpnews("llh", null, null,
					Constants.ASSISTANT_AGENTID, mpnewsItems, 0);
